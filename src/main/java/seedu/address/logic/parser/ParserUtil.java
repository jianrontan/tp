...
public class ParserUtil {
    ...
    /**
     * Parses a {@code String bodyFatPercentage} into a {@code BodyFatPercentage}.
     * Leading and trailing whitespaces will be trimmed.
     *
     * @throws ParseException if the given {@code bodyFatPercentage} is invalid.
     */
    public static BodyFatPercentage parseBodyFatPercentage(String bodyFatPercentage) throws ParseException {
        requireNonNull(bodyFatPercentage);
        String trimmedBodyFat = bodyFatPercentage.trim();
        if (!BodyFatPercentage.isValidBodyFatPercentage(trimmedBodyFat)) {
            throw new ParseException(BodyFatPercentage.MESSAGE_CONSTRAINTS);
        }
        return new BodyFatPercentage(trimmedBodyFat);
    }
